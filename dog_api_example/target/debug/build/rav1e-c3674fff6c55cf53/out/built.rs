...
#[allow(dead_code)]
pub static RUSTC: &str = "/home/codespace/.rustup/toolchains/stable-x86_64-unknown-linux-gnu/bin/rustc";
#[doc=r#"The documentation generator that cargo resolved to use."#]
#[allow(dead_code)]
pub static RUSTDOC: &str = "/home/codespace/.rustup/toolchains/stable-x86_64-unknown-linux-gnu/bin/rustdoc";
...
#[doc=r#"The output of `/home/codespace/.rustup/toolchains/stable-x86_64-unknown-linux-gnu/bin/rustc -V`"#]
#[allow(dead_code)]
pub static RUSTC_VERSION: &str = "rustc 1.89.0 (29483883e 2025-08-04)";
#[doc=r#"The output of `/home/codespace/.rustup/toolchains/stable-x86_64-unknown-linux-gnu/bin/rustdoc -V`; empty string if `/home/codespace/.rustup/toolchains/stable-x86_64-unknown-linux-gnu/bin/rustdoc -V` failed to execute"#]
#[allow(dead_code)]
